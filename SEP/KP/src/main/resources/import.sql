...
insert into seller (id, client, client_id, client_password, magazine, magazine_id, bitcoin_token, bank_name) values (1, '1','1','123','magazin', 1, 'LePn5ZVweTDw_3yquEPHP-BhfFuS15-D3U5ggYb8', 'bank1');
insert into seller (id, client, client_id, client_password, magazine, magazine_id, bitcoin_token, bank_name) values (2, '2','2','123','magazin 1', 2, '9gLpd_BuuCxxzqp25ZCKMPfkkRSgXfXyYGzMLTL_', 'bank2');
